...
def app(diabetes_df):
    ...
    glucose=st.slider("Glucose",diabetes_df["Glucose"].min(),diabetes_df["Glucose"].max())
    bp=st.slider("Blood pressure",diabetes_df["BloodPressure"].min(),diabetes_df["BloodPressure"].max())
    insulin=st.slider("Insulin",diabetes_df["Insulin"].min(),diabetes_df["Insulin"].max())
    bmi=st.slider("BMI",diabetes_df["BMI"].min(),diabetes_df["BMI"].max())
    pedigree=st.slider("Pedigree",diabetes_df["DiabetesPedigreeFunction"].min(),diabetes_df["DiabetesPedigreeFunction"].max())
    age=st.slider("Age",diabetes_df["Age"].min(),diabetes_df["Age"].max())
